...
parser.add_argument('-s', '--image_size', type=int, default=32,
                    help='image size')
parser.add_argument('-m', '--model', nargs='+', type=str, default= 'Mobilenet',
...
for i in range(len(m)):
    ...
    for epoch in range(epochs):
        ...
        save_best_model(
            a, valid_epoch_acc, current_valid_loss epoch, model, optimizer, criterion
        )
        print('-'*50)
